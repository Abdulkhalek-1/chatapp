	...
	return (
		<>
			<form
				...
				onSubmit={onsubmit}
				className={cn(
					"w-[min(100%,24rem)] min-h-[25rem] shadow-lg rounded-lg p-4 dark:bg-slate-950 bg-white shodow-lg dark:shadow-none",
					className,
				)}
			>
...
function SubmitBtn({
	...
	return (
		<Button {...restProps} className={cn("w-full mb-3.5", restProps.className)}>
			{children}
		</Button>
	);
}
